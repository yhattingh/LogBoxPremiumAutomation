...
public class PageObjectsMessagePatientPage extends BasePageFrameWork {
	...
	public void clickOnSmsRadioButton() {
		clickElement(By.cssSelector(
				"div[role='list'] > div:nth-of-type(1) .v-input__slot > div[role='radiogroup'] .v-input--selection-controls__ripple"));
	}

	public void clickOnEmailRadioButton() {
		clickElement(By.cssSelector(
				"div[role='list'] > div:nth-of-type(2) .v-input__slot > div[role='radiogroup'] .v-input--selection-controls__ripple"));
	}

	public void clickOnQuestionnaireExpandButton() {
		clickElement(By.cssSelector(
				"div:nth-of-type(2) > .v-expansion-panel-header  .material-icons.notranslate.theme--light.v-icon"));
	}

	public void clickOnFormsExpandButton() {
		clickElement(By.cssSelector(
				"div:nth-of-type(3) > .v-expansion-panel-header  .material-icons.notranslate.theme--light.v-icon"));
	}

	public void clickOnAppointmentReminderExpandButton() {
		clickElement(By.cssSelector(
				"div:nth-of-type(4) > .v-expansion-panel-header  .material-icons.notranslate.theme--light.v-icon"));
	}
